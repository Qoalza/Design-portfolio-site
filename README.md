...
Пользовательский запуск, local storage, preview, Figma read-only import и sandbox/live publish описаны в:
...
MDX остаётся вспомогательной/тестовой возможностью репозитория, но не является текущим хранилищем опубликованных проектов.
