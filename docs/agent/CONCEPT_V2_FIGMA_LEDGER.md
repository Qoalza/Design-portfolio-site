...
| `3075:60331`, `3116:67190` | Outer fields | 1440×240 each; outer top field has a full-width 1 px bottom stroke and outer bottom field a full-width 1 px top stroke; the centered 1280×239 patterned child has independent 1 px left/right strokes; all use `#2e3133` | Exact node exports remain the field backgrounds; structural CSS strokes independently preserve the full-width boundary and centered 1280 px side rails when the viewport is wider than 1440 px or the field is vertically compressed | matches; exact Plugin API geometry plus runtime at 1920×1600 |
