...
| `3075:60331`, `3116:67190` | Outer fields | 1440×240 each; 1280 px patterned inner field; the top export contains its lower separation rule | Exact node exports are used locally; the top image is bottom-anchored and the bottom image top-anchored so compression cannot crop the boundary rule | matches; runtime at 1440×1080 |
