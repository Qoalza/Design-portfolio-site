...
| `3110:65162`, `3110:65196` | Shade | 473×417 exact exported radial shade; visible in Enable | transparent | Exact `public/figma/project-shade.svg` is positioned at top 33 px / right 31.5 px, extends below the 329 px preview, and transitions opacity in 150 ms Ease In |
...
| User contract | Scroll mechanics | document scroll; locally paced experience travel; no wheel interception and no global page-speed modification | 1615 px horizontal / 4845 px vertical (3 vertical px per horizontal px); passive scroll listener; existing Lenis remains the only continuous RAF at its original `wheelMultiplier: 1` | matches; an 800 px document movement advances less than one fifth of the experience tape |
