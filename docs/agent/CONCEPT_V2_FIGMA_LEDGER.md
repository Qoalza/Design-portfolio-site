...
| `3108:64584` | Current card | Previously recorded geometry is insufficient: the current date-marker child structure and state colors require a fresh exact-node read | Existing approximation remains in runtime pending exact source inspection | blocked only for this dependent visual slice: Figma transport unavailable on 2026-09-13; no values inferred from screenshots |
