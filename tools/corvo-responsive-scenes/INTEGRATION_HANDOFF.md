...
Эталонные viewport: Desktop 1660 × 960, Tablet 744 × 1100, Mobile 360 × 640. Desktop-фрейм занимает полные 1660px.
Диапазоны: Mobile 360–599px, Tablet 600–1279px, Desktop 1280px и шире.
Исходный desktop-фрейм — 1660 × 960; эти размеры не являются breakpoint.
...
После переноса проверить все четыре сцены на 360px, 744px, 1279px, 1280px и 1660px, отсутствие
