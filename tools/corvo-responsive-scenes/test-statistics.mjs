...
assert.match(css, /@media \(min-width: 600px\) and \(max-width: 1279px\)[\s\S]*?\.statistics \.table-wrap > table \{[^}]*width: 1221px/, 'Tablet table keeps its fixed source width');
...
assert.match(css, /@media \(min-width: 600px\) and \(max-width: 1279px\)[\s\S]*?\.statistics \.table-wrap footer \{ height: 68px; \}/, 'Tablet Statistics footer keeps the source 68px pagination frame');
