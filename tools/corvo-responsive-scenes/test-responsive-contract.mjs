...
assert.match(authorization, /@media \(min-width: 1280px\)[\s\S]*?\.auth-panel \{ border-radius: 32px; \}/, 'Authorization desktop card keeps its 32px radius');
...
assert.match(campaignsCss, /@media \(min-width: 1280px\)/, 'Media campaigns enters Desktop at 1280px');
