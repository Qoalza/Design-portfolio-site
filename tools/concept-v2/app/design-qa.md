...
- The complete 1440×240 Figma exports already contain the horizontal boundary and centered 1280×239 child rails. Adding structural CSS strokes duplicated those pixels and exposed artifacts at the side gutters; the exports are now the sole renderer for this geometry.
...
- Corrected field proof at 1920×1600: the bottom field is the single centered 1440×240 Figma export, with one horizontal boundary and its built-in 1280×239 child rails; the surrounding viewport gutters are solid and free of duplicate strokes or pattern fragments. Horizontal overflow remains zero.
...
6. Follow-up fidelity/regression review verified that the exact full-frame exports own the field strokes, removed duplicate CSS geometry, and exercised full forward, reverse, second-entry escape and third-entry resume cycles with the real Lenis runtime.
