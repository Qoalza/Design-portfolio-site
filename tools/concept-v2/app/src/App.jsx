...
function Hero(){
 ...
 return <section className="hero" data-layout={layout} aria-labelledby="hero-title">
  ...
  <div className="hero-bottom"><span className="hero-bottom-dots" aria-hidden="true"/><span className="hero-bottom-wave" aria-hidden="true"><img src="/figma/hero-bottom-wave.svg" alt=""/></span><div className="hero-bottom-inner"><p className="hero-fact-chip">29 лет · Екатеринбург · Senior</p></div></div>
 </section>;
}
