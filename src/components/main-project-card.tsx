  ...
  return (
    <article className={styles.card}>
      <div className={styles.visual} aria-hidden="true">
        {project.catalogFrame ? <ProjectFrameCompositionView composition={project.catalogFrame} className={styles.structuredVisual} fillSlot /> : visualBack ? <span className={`${styles.visualFrame} ${styles.visualBack}`}>
