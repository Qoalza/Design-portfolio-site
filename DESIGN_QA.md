...
## OPEN — raw Admin transfer labels

В legacy-экране transition могут отображаться технические подписи `detailAvailable` и `hero` вместо пользовательских названий. Это не влияет на перенос данных или публикацию; исправление интерфейса находится вне текущей стабилизации и требует отдельной UI-задачи.
