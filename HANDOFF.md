...
- Runtime checkpoint: `353149a` (`fix(concept-v2): render large hero fade in css`).
...
- Large runtime inspection at `2400×1280`, DPR 1: the field is `560px` high, its grid remains `16px` at `0 0`, the obsolete Large SVG mask computes to `none`, and the CSS overlay resolves to the radial bowl plus the five-stop vertical Bg-main gradient.
