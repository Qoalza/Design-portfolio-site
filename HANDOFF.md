...
- Предыдущий статус готовности локальной админки был снят как недоказанный (`NOT_READY`). Текущая Goal повторно прошла браузерные пользовательские сценарии и имеет статус `READY_FOR_USER_REVIEW`, но не `CLOSED`.
