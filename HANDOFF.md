...
- `npm run check`: passed — lint, `51/51` tests, production build at `7505593`.
- `npm run check:browser`: passed — built runtime smoke after the post-review corrections.
